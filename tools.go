...
const randomStringSource = "abcdefghijklmnopqrstuvwxyzABCDEFGHIKJLMNOPQRSTUVWXYZ0123456789_+"
...
// UploadedFile is the struct used to save information about an uploaded file
...
// PushJSONToRemote posts arbitrary data to some URL as JSON, and returns the response, status code and and error if any
